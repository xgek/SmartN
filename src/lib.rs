...
#[derive(Debug)]
pub struct NFTEngineProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NFTEngineProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NFTEngine processing");
    
    let mut processor = NFTEngineProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NFTEngineProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NFTEngineProcessor::new(false);
